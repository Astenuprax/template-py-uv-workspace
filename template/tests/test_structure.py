...
# AGENTS.local.md is part of the base furniture set (template-governance-base ships it
# skip_if_exists and its tools/governance_checks.py allows it); it MUST be allow-listed here
# too or the composed render fails the structure-lint while passing the base governance hook.
